...
const STAFF_ITEMS: Item[] = [
  {
    ...
    answer:
      "出勤・退勤はホームの打刻ボタンから行います。一度退勤したあとでも、同じ日に再出勤できます。打刻内容に誤りがある場合は、管理者へ修正を依頼してください。",
  },
  {
    id: "staff-shift",
    title: "シフトを確認・変更したい",
    ...
    answer:
      "登録済みシフトはシフト画面から確認できます。変更が必要な場合は、確定状況を確認したうえで管理者へ連絡してください。",
  },
  {
    id: "staff-money",
    ...
    answer:
      "今月の確定受取金額と次回支払予定日は、ホームの「今月の確定受取金額」または支払情報から確認できます。",
  },
  {
    id: "staff-expense",
    title: "交通費・経費を申請したい",
    ...
    answer:
      "交通費・宿泊費などの経費は申請画面から登録してください。対象月・内容・金額を確認して送信してください。",
  },
  {
    id: "staff-mnp",
    ...
    answer:
      "MNP予約番号や番号移行はキャリア・契約状態によって手順が変わります。このBOTに登録済みの手順がない場合は、必ず各キャリア公式情報または普段使用している検索・AIサービスで最新条件を確認してください。",
  },
  {
    id: "staff-plan",
    title: "料金プランについて調べたい",
    ...
    answer:
      "料金プラン・割引条件は変更されることがあります。BOTに登録されている情報だけで判断できない場合は、各キャリアの最新公式情報を確認してください。",
  },
  {
    id: "staff-device",
    title: "機種・端末について調べたい",
    ...
    answer:
      "機種仕様や対応SIMはモデルごとに異なります。登録済み回答で不足する場合は、メーカーまたはキャリアの公式仕様ページで確認してください。",
  },
];
        ...
        >
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className={`mt-0.5 text-[11px] font-bold ${audience === "staff" ? "text-slate-400" : "text-slate-300"}`}>
                固定回答・AI利用なし
              </div>
            </div>
            <button
