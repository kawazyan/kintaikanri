...
export function ShiftCalendar({ days, shiftsByDate, todayDateKey, prevMonth, nextMonth, monthLabel }: {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between game-hud-frame game-cut-card rounded-[18px] px-2 py-2 shadow-[0_4px_16px_rgba(15,23,42,.07)] ring-1 ring-black/5">
      ...
      <div className="game-hud-frame game-cut-card rounded-[20px] p-3 shadow-[0_5px_18px_rgba(15,23,42,.08)] ring-1 ring-black/5">
      ...
      <section className="flex flex-col gap-3">
        ...
        {selected && selectedShifts.length === 0 ? (
          <div className="game-hud-frame game-cut-card rounded-[20px] px-5 py-8 text-center shadow-[0_5px_18px_rgba(15,23,42,.07)] ring-1 ring-black/5">
        ...
        {selectedShifts.map((s) => (
          <article key={s.id} className="game-hud-frame game-cut-card overflow-hidden rounded-[20px] shadow-[0_5px_18px_rgba(15,23,42,.08)] ring-1 ring-black/5">
