  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-sm flex-col gap-6 px-4 pt-6 pb-28">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-center">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-b from-white to-slate-100 shadow-[0_4px_14px_rgba(0,0,0,0.3)]">
          <Users size={28} className="text-amber-500" />
        </div>
        <h1 className="text-lg font-bold text-slate-200">仲間のタウン</h1>
