...
export function RequestForm({ availableAmount }: { availableAmount: number }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#16283a] via-[#102235] to-[#091623] px-4 py-4 text-center text-white shadow-[0_6px_20px_rgba(234,88,12,0.4)] ring-1 ring-white/10">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/25 to-transparent" />
        <p className="relative text-xs font-bold tracking-wide text-slate-200 uppercase">
          振込申請可能額
        </p>
